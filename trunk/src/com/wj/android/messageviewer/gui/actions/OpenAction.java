...
public class OpenAction extends AbstractAction
{
    ...
    */
   public OpenAction(final TitaniumBackupMessageViewer caller, final JFrame frame, final RecentCollection<Pair<String, String>> recentCollection,
   ...
   public void actionPerformed(final ActionEvent e)
   {
      ...
      if (null != strMessageFilePath)
      {
         ...
         new LoadMessagesWorker(m_Caller, m_Frame, new Pair<>(strMessageFilePath, strContactDatabaseFilePath), m_RecentCollection, m_ThreadListBox, m_NumberSMSField,
                                m_MessageViewer, m_ScrollPaneThread).execute();
      }
      else
         JOptionPane.showMessageDialog(m_Frame, "Choose message file first!");
   }
